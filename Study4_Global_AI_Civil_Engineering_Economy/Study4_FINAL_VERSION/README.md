...
**Final version (unpacked + all zips):** `Study4_Global_AI_Civil_Engineering_Economy/Study4_FINAL_VERSION/`

Finished zip archives: `Study4_zip_packages/` (final-version copies also in `Study4_zip_packages/Study4_FINAL_VERSION/`).
