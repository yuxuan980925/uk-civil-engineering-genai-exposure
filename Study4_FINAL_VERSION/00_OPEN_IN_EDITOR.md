...
Cursor / GitHub **不能预览 zip、xlsx 等二进制文件**（会提示 *binary file is not supported*）。

请打开下面的 **Markdown / CSV**，不要打开 `zips/` 里的压缩包。
...
| [`manuscript/tables_for_article.md`](manuscript/tables_for_article.md) | 全部文章表格 |
| [`tables/`](tables/) | CSV，编辑器可直接打开 |
| [`data/`](data/) | 官方数据 CSV |

Zip 只作下载备份，在 [`zips/`](zips/)（本地解压用，不要在 IDE 里打开）。
